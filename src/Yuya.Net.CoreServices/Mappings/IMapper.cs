...
namespace Yuya.Net.CoreServices.Mappings
{
  ...
  public interface IMapper
  {
    ...
    /// <returns></returns>
    IResult<TValue> GetResult<TValue>(object value);
    ...
    /// <returns></returns>
    IResult<TValue> GetResult<TValue>(Error error);
  }

  /// <summary>
  /// The mapper interface with typed profile. This interface using for simply DI resolve operations.
  /// </summary>
